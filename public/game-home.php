...
<body class="min-h-screen">
    ...
    <header class="fixed top-0 left-0 right-0 z-30 bg-black bg-opacity-50 backdrop-blur-sm border-b border-gray-700">
        <div class="container mx-auto px-4 h-16 flex items-center justify-between">
            <!-- Logo -->
            <a href="game-home.php" class="flex items-center space-x-2">
            ...
            <nav class="flex items-center space-x-4">
                <a href="game-home.php" class="text-white hover:text-blue-300 transition">首页</a>
                <a href="test-game.php" class="text-white hover:text-blue-300 transition">游戏列表</a>
                <a href="test-links.html" class="text-white hover:text-blue-300 transition">测试</a>
                            ...
                            <div class="category-card rounded-lg p-6 text-center transition-all duration-300">
                                <div class="text-4xl mb-3">
                                    ...
                                    $icons = [
                                        ...
                                        'Cards' => '🃏', 'Adventure' => '🗺️', 'Mining' => '⛏️', 'Idle' => '⏰',
                                        'Clicker' => '🖱️', 'Simulation' => '⚙️', 'Tycoon' => '🏢', 'Arcade' => '🎮',
                                        'Board' => '🎲', 'Multiplayer' => '👥', 'IO' => '🌐', 'Platformer' => '🦘',
                                        'Educational' => '📚', 'Music' => '🎵'
                                    ];
        ...
        <div class="container mx-auto px-4 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="game-home.php" class="text-gray-300 hover:text-white transition">首页</a></li>
                        <li><a href="test-game.php" class="text-gray-300 hover:text-white transition">游戏列表</a></li>
                        <li><a href="test-links.html" class="text-gray-300 hover:text-white transition">测试链接</a></li>
                    </ul>
                </div>
                <div>
